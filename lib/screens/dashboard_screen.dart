...
import 'incoming_parcels_screen.dart';
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final preview = store.allPendingParcels.take(2).toList();
        return Scaffold(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () {
                      store.triggerTestOrderRequest();
                    },
                    icon: const Icon(Icons.notifications_active_outlined, size: 18),
                    label: Text(
                      'Trigger Test Order Request',
                    ...
                    children: [
                      Expanded(
                        child: _StatCard(
                          ...
                          value: '${store.todayReceivedCount}',
                        ),
                      ),
                    ...
                    ...preview.map(
                      (p) => Padding(
                        ...
                        child: ParcelCard(
                          ...
                          trailing: p.viewed
                              ? ParcelTrailing.inProgress
                              : ParcelTrailing.newBadge,
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
