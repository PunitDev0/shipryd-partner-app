          ...
          body: SafeArea(
            child: ListView(
              ...
              children: [
                ...
                if (store.recentRatedTrips.isEmpty)
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 24),
                    child: Center(
                  ...
                  ...store.recentRatedTrips.map((trip) => Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(trip.orderId, style: GoogleFonts.inter(fontSize: 12.5, fontWeight: FontWeight.w700)),
                                  Row(
                                    children: List.generate(
                                      5,
                                      (i) => Icon(
                                        i < (trip.rating ?? 0) ? Icons.star_rounded : Icons.star_outline_rounded,
                                        size: 14,
                                        color: AppColors.primaryDark,
                                      ),
                                    ),
                              ...
                              if ((trip.comment ?? '').isNotEmpty) ...[
                                const SizedBox(height: 6),
                                Text(trip.comment!, style: GoogleFonts.inter(fontSize: 13, color: AppColors.textSecondary)),
                              ],
                              const SizedBox(height: 6),
                              Text(
